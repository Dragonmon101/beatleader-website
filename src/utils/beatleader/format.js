...
export const HMDs = {
	...
	57: {
		name: 'Nvidia CloudXR',
		icon: 'nvidia.svg',
		color: 'invert(0%) sepia(0%) saturate(100%) hue-rotate(0deg) brightness(100%) contrast(100%)',
		priority: 33,
	},
	58: {
		name: 'VRidge',
	...
	50: {
		name: 'DPVR E3',
		icon: 'dpvr.png',
		color: 'invert(50%) sepia(100%) saturate(600%) hue-rotate(20deg) brightness(100%) contrast(150%)',
		priority: 35,
	},
	59: {
		name: 'Medion Erazer X1000',
		icon: 'medion.png',
		color: '',
		priority: 36,
	},
